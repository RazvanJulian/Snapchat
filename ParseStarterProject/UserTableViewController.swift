...
//
//  Created by Razvan  Julian on 10/01/2018.
...
class UserTableViewController: UITableViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]) {
        ...
        if let image = info[UIImagePickerControllerOriginalImage] as? UIImage {
            ...
            imageToSend["photo"] = PFFile(name: "photo.jpeg", data: UIImageJPEGRepresentation(image, 0.5)!) //(name: "photo.png", data: UIImagePNGRepresentation(image)!)
